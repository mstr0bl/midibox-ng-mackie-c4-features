...
typedef enum {
  ...
  MBNG_EVENT_SYSEX_VAR_VAL_B0,
  MBNG_EVENT_SYSEX_VAR_VAL_B1,
  MBNG_EVENT_SYSEX_VAR_VAL_B2,
  MBNG_EVENT_SYSEX_VAR_VAL_B3,
  MBNG_EVENT_SYSEX_VAR_VAL_B4,
  MBNG_EVENT_SYSEX_VAR_VAL_B5,
  MBNG_EVENT_SYSEX_VAR_VAL_B6,
  MBNG_EVENT_SYSEX_VAR_VAL_B7,
  MBNG_EVENT_SYSEX_VAR_VAL_B10,
